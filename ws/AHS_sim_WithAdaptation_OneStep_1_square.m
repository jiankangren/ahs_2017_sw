...
safe_x = [2.75 2.75 4.25   4.25 7.75 7.75 6.25 6.25 12.25 12.25 9.25 9.25 12.25 12.25 7.75  7.75 2.75 2.75 1.25    1.25]';
safe_y = [0.25 2.75 2.75   7.25 7.25 5.25 5.25 1.25 1.25   2.25 2.25 7.25 7.25  11.75 11.75 8.75  8.75  5.25 5.25 0.25]';
plot(safe_x,safe_y);
x_X =[2;0];
x_Y =[1;0];
